...
if(isset($_POST['add']))
{
    ...
    {
        $User->add($username, md5($password) ,$phone ,$gender ,$email, $birthday,$account_type);
    }
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="#" method="POST">
                            ...
                            <div class="form-group">
                                <label>Gender</label>
                                <input class="form-control" name="txtGender" />
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" name= "add" class="btn btn-default">User Edit</button>
